...
-- Disable unused providers to silence checkhealth noise
vim.g.loaded_perl_provider = 0
vim.g.loaded_ruby_provider = 0

-- Filetype detection for extensions Neovim doesn't know out of the box
vim.filetype.add {
  extension = {
    hbs = 'html', -- Handlebars templates → html LSP
  },
}

-- Folding (UFO defaults)
vim.o.foldcolumn = '1'
vim.o.foldlevel = 99
